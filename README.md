...
```
npm create cloudflare@latest -- --template=cloudflare/templates/seokickai
```

A live public deployment of this template is available at [https://seokickai.templates.workers.dev](https://seokickai.templates.workers.dev)
